                    ...
                    <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative border-dark border-5 shadow-lg" style="background-color: white">
                        ...
                        <%
                            ...
                            try {
                                ...
                                out.println("<p class='h1 text-success '>Congrats!! Your Ticket Booked Successfully.</p>");
                                session.setAttribute("username", lgnm);
                                out.print("<h2 style='margin-top: 20px;' class='text-dark  '><b>Name : </b>" + lgnm + "</h2>");
                                out.println("<h2 class='text-dark  '><b>Source : </b>" + source + "</h2>");
                                out.println("<h2 class='text-dark  '><b>Destination : </b>" + dest + "</h2>");
                                out.println("<h2 class='text-dark  '><b>Date :</b> " + date + "</h2>");
                                out.println("<h2 class='text-dark  '><b>Time : </b>" + time + "</h2>");
