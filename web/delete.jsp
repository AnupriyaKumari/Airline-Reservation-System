<%-- 
    Document   : delete
    Created on : 06-Apr-2022, 12:29:42 pm
    Author     : ANUPRIYA
--%>
                ...
                <div class="col-md-7 offset-md-3">
                    <div class="card">
                        <div class="card-header text-center ">
                            <span class="fa fa-3x fa fa-trash"></span>
                            <br>
                            Cancel Your Ticket!!<br>                    
                        </div>
                        <div class="card-body text-dark">
                            <form action="deleteData.jsp"  method="POST" >
                                ...
                                <div class="mb-3 form-check text-center mt-2">
                                    ...
                                    <label class="form-check-label text-dark " for="agree">Yes, I want to cancel my ticket.</label>
                                </div>
                                <div class="text-center">
                                    <button type="submit" class="btn btn-danger btn-lg">Cancel Ticket!</button>
                                </div>
